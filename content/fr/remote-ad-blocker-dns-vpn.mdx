...
5. J'ai confirmé l'empreinte SSH en tapant "yes" et saisi le mot de passe par défaut ("raspberry")
   ![Empreinte SSH Raspberry Pi](/blog/project-adguard-fingerprint.jpg)
...
![Configuration des filtres AdGuard Home](/blog/project-adguard-filters.png)
...
![Configuration de la redirection de port](/blog/project-adguard-port.png)
...
![Configuration DHCP d'AdGuard Home](/blog/project-adguard-baux.jpg)
