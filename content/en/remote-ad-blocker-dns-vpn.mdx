...
5. Confirmed the SSH fingerprint by typing "yes" and entered the default password ("raspberry")
   ![Raspberry Pi SSH fingerprint](/blog/project-adguard-fingerprint.jpg)
...
3. I navigated to the provided URL in my browser (typically _http://<raspberry_pi_IP>:3000_).

4. During the initial setup, I selected the _eth0_ network interface in the "Listen Interfaces" option to ensure AdGuard would work across my entire network.
...
![AdGuard Home Filters Configuration](/blog/project-adguard-filters.png)
...
![Port Forwarding Configuration](/blog/project-adguard-port.png)
...
![AdGuard Home DHCP Configuration](/blog/project-adguard-baux.jpg)
...
_This project combines networking, Linux administration, and security concepts to create a practical solution for everyday problems._
