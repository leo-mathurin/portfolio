...
![Oracle Cloud VM Configuration](/blog/project-minecraft-config.png)
_Obviously not my own instance, but you get the idea_
...
5. Configured server properties:
   ...
   - _server-port=25565_ (default Minecraft port)
   - _difficulty=normal_
   - _max-players=10_
   - _view-distance=10_
...
![Oracle Cloud Security Rules](/blog/project-minecraft-firewall.png)
...
_This project combines cloud infrastructure, Linux system administration, and game server management to create a cost-effective solution for Minecraft enthusiasts._
